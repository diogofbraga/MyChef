...
namespace Workshop1.Controllers{
    ...
    public class UserController : Controller{
        ...
        public User[] Get(){
            ...
            return new[] {
                    new User() {codigo = 1, nome = "Ugo", email = "teste@gmail.com"}, 
                    new User() {codigo = 2, nome = "Simone", email= "Chiaretta@gmail.com"} 
                    };
        }
        ...
        public User Get(int codigo){
            ...
            var users = new[] {
                    new User() {codigo = 1, nome = "Ugo", email = "Lattanzi@gmail.com"}, 
                    new User() {codigo = 2, nome = "Simone", email = "Chiaretta@gmail.com"} 
                    };
